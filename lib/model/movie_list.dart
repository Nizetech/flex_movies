...
// //   static List<Movie> movieListFromSnapshot(List movieSnapshot) {
// //     return movieSnapshot.map((data) {
// //       print('data $data');
...
final typeValues = EnumValues({"web": Type.WEB});
